...
@section('title')Tiendas Online @endsection
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-condensed table-bordered table-hover table-striped" id="tableStore">
                        <thead>
                            <tr>
                                <th>Nombre</th>
                                <th>Website</th>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <h6>Link Website</h6>
                                <input type="text" class="form-control input-sm" name="website" placeholder="Nombre del sitio web">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#tableStore").DataTable({
                ...
                language: idioma,
                ajax: {
                    url: "{{ route('lists.list-store-shop') }}",
                    type: "GET",
                ...
                buttons: [
                    {
                        ...
                        action: function () {
                            var store = "{{ route('configurations.store-shop.store') }}";
                            $("#formulario")[0].reset();
            ...
            $("#tableStore tbody").on("click", "a.edit_dt", function () {
                showData($(this).data("route"), $(this).data("update"));
            });

            $("#tableStore tbody").on("click", "a.delete_dt", function () {
        ...
        function showData(route, update) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("[name=website]").val(response.website);
                    $("#modal-data").modal("show");
