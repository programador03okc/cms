...
@section('title')Tipo de Cambio @endsection
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-condensed table-bordered table-hover table-striped" id="tableTypeChange">
                        <thead>
                            <tr>
                                <th>Valor tipo de cambio</th>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <h6>Valor del tipo de cambio</h6>
                                <input type="number" class="form-control input-sm text-center" name="name" placeholder="Ingrese el valor" value="0.00" step="any" min="0" required>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#tableTypeChange").DataTable({
                ...
                language: idioma,
                ajax: {
                    url: "{{ route('lists.list-type-change') }}",
                    type: "GET",
                ...
                buttons: [
                    {
                        ...
                        action: function () {
                            var store = "{{ route('configurations.type-change.store') }}";
                            $("#formulario")[0].reset();
            ...
            /*$("#tableTypeChange tbody").on("click", "a.edit_dt", function () {
                showData($(this).data("route"), $(this).data("update"));
            });

            $("#tableTypeChange tbody").on("click", "a.delete_dt", function () {
        ...
        function deleteData(route){
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#tableTypeChange").DataTable().ajax.reload();
                }
            }).fail( function (jqXHR, textStatus, errorThrown) {
                console.log(jqXHR);
                console.log(textStatus);
