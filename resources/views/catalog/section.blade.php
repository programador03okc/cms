...
@section('title')Tipo de Banner @endsection

@section('breadcrumb')
<h1 class="m-0 text-dark">Tipo de Banner</h1>
<ol class="breadcrumb">
    <li><a href="javascript: void(0);"><i class="fa fa-dashboard"></i> CMS OK COMPUTER</a></li>
    <li>Diseño</li>
    <li class="active">Tipo de Banner</li>
</ol>
@endsection
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <h6>Descripción</h6>
                                <input type="text" class="form-control input-sm" name="description" placeholder="Ingrese una descripción" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                buttons: [
                    {
                        ...
                        action: function () {
                            var store = "{{ route('catalogs.section.store') }}";
                            $("#formulario")[0].reset();
