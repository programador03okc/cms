            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.response == 'ok') {
                        ...
                        var rpta = "Se vinculó al producto ";// + response.data[0].title;
                        notify("success", rpta);
                    } else if (response.response == 'exist') {
                        notify("info", "El producto ya se agregó en la lista de productos pendientes");
                    } else if (response.response == 'null') {
                        notify("info", "Se agregó a la lista de productos pendientes");
                    } else {
                        notify("error", "Hubo un problema. Por favor intente de nuevo");
                    }
                    */
                }
            });
